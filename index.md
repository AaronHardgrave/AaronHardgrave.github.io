...
<section class="hero">
  <div class="hero-inner">
    <img src="images/headshot.PNG" alt="Aaron J. Hardgrave" class="hero-photo">
    <div class="hero-text">
      <h1>Aaron J. Hardgrave</h1>
      <p class="subtitle">PhD Candidate in Biomedical Sciences</p>
      <p class="affiliation">East Tennessee State University – Quillen College of Medicine</p>
...
<div class="cards">
  <div class="card">
    <h3>Research</h3>
    <p>Dissertation research on Eastern newt functional morphology, publications, conference presentations, and imaging media.</p>
    <a href="research/" class="card-link">View Research &rarr;</a>
  </div>
  <div class="card">
    <h3>Teaching</h3>
    <p>Anatomy instruction across medical, health sciences, and undergraduate programs with emphasis on functional understanding.</p>
    <a href="teaching/" class="card-link">View Teaching &rarr;</a>
  </div>
  <div class="card">
    <h3>CV &amp; Contact</h3>
    <p>Full curriculum vitae, professional profiles, technical skills, and contact information.</p>
...
<div class="media-block">
  ...
  <p class="caption">Slice-by-slice visualization of eastern newt hindlimb musculature captured using diceCT imaging</p>
</div>
